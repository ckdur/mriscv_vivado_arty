...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ddr3 xil_defaultlib.ddr3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim ddr3 -key {Behavioral:sim_1:Functional:ddr3} -tclbatch cmd.tcl -log simulate.log
}
