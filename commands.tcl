...
write_cfgmem  -format mcs -size 16 -interface SPIx1 -loadbit "up 0x00000000 ./mriscv_vivado.runs/impl_1/impl_axi.bit " -loaddata "up 0x00800000 ./add.dat " -force -file "./program.mcs"
